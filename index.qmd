...
La asignatura se desarrollará en modalidad presencial, utilizando la estrategia de **Clase Invertida**:

::: {.callout-flipped}
### 📖 Trabajo Autónomo
Los estudiantes revisarán videos, lecturas y materiales antes de la clase.
:::

::: {.callout-flipped}
### 🗣️ Sesión Presencial (Momento 1 - 60 min)
Discusión dirigida, resolución de dudas y fortalecimiento de conceptos en grupo.
:::

::: {.callout-flipped}
### 💻 Sesión Presencial (Momento 2 - 60 min)
Desarrollo práctico de problemáticas o talleres aplicados (ej. análisis de casos, uso de herramientas web).
:::
